...
The goal of this project is to use historical weather data and sentinel-2 satalite imagry to predict the probabilty of a wildfire occuring and the path it will take.
